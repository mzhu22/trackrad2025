...
# Double magnitude brightness, contrast, gamma augmentation
# And double the probability
class nnUNetTrainerDAMikeContrast2(nnUNetTrainer):
    @staticmethod
    def get_training_transforms(
        ...
        transforms.append(
            SpatialTransform(
                ...
                random_crop=False,
                # Update p_elastic_deform to 0.2 for more aggressive augmentation
